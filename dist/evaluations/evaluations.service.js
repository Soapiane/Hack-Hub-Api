...
let EvaluationsService = class EvaluationsService {
    constructor(evaluationRepository, judgingCriteriaRepository, judgeAssignmentRepository) {
    ...
    async create(createEvaluationDto, user) {
        ...
        const evaluation = this.evaluationRepository.create(Object.assign(Object.assign({}, createEvaluationDto), { judgeId: user.id }));
    ...
    async findOne(id, user) {
        ...
        if (user.role === role_enum_1.Role.JUDGE && evaluation.judgeId !== user.id) {
