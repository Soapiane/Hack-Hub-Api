...
let TeamRegistrationController = class TeamRegistrationController {
    ...
    async getOneTeam(hackathonId, id) {
    ...
    async removeParticipantFromTeam(hackathonId, participantEmail) {
        return this.teamRegistrationService.removeParticipantFromTeam(hackathonId, participantEmail);
    }
};
...
__decorate([
    (0, common_1.Post)('validate-emails'),
    (0, roles_decorator_1.Roles)(role_enum_1.Role.ADMIN),
    ...
    (0, swagger_1.ApiBody)({ type: team_registration_dto_1.BodySchemaDto }),
    __param(0, (0, common_1.Param)('hackathonId')),
...
__decorate([
    ...
    __metadata("design:returntype", Promise)
], TeamRegistrationController.prototype, "getAllTeams", null);
__decorate([
    (0, common_1.Get)(':id'),
    (0, roles_decorator_1.Roles)(role_enum_1.Role.ADMIN),
    (0, swagger_1.ApiOperation)({ summary: 'Get one team' }),
    (0, swagger_1.ApiResponse)({
        status: 200,
    ...
    __metadata("design:returntype", Promise)
], TeamRegistrationController.prototype, "getOneTeam", null);
__decorate([
    (0, common_1.Post)('add-participant'),
    (0, roles_decorator_1.Roles)(role_enum_1.Role.ADMIN),
    (0, swagger_1.ApiOperation)({ summary: 'Add participant to team' }),
    (0, swagger_1.ApiResponse)({
        status: 200,
        description: 'Participant added to team successfully.',
    }),
    (0, swagger_1.ApiParam)({ name: 'hackathonId', required: true }),
    (0, swagger_1.ApiBody)({ type: team_registration_dto_1.AddParticipantToTeamDto }),
    __param(0, (0, common_1.Param)('hackathonId')),
    ...
    __metadata("design:returntype", Promise)
], TeamRegistrationController.prototype, "addParticipantToTeam", null);
__decorate([
    (0, common_1.Post)('remove-participant-from-team'),
    (0, roles_decorator_1.Roles)(role_enum_1.Role.ADMIN),
    (0, swagger_1.ApiOperation)({ summary: 'Add participant to team' }),
    (0, swagger_1.ApiResponse)({
        status: 200,
    ...
    (0, swagger_1.ApiParam)({ name: 'hackathonId', required: true }),
    (0, swagger_1.ApiBody)({ type: team_registration_dto_1.removeParticipantFromTeamDto }),
    __param(0, (0, common_1.Param)('hackathonId')),
    __param(1, (0, common_1.Body)('participantEmail')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, String]),
    __metadata("design:returntype", Promise)
], TeamRegistrationController.prototype, "removeParticipantFromTeam", null);
