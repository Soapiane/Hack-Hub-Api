...
export declare class EvaluationsService {
    ...
    constructor(evaluationRepository: Repository<Evaluation>, judgingCriteriaRepository: Repository<JudgingCriteria>, judgeAssignmentRepository: Repository<JudgeAssignment>, submissionRepository: Repository<Submission>);
